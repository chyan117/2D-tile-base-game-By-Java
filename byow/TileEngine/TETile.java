...
//    char, Color, Color, String
    ...
    public boolean equals(Object o){
        ...
        TETile t = (TETile)o;
        if(t.character!=this.character){
            return false;
        }
        if(!t.textColor.equals(this.textColor)){
            return false;
        }
        if(!t.backgroundColor.equals(this.backgroundColor)){
            return false;
        }
        ...
        if(t.filepath==null){
            ...
            if(t.filepath.equals(this.filepath)){
                return false;
            }
        }
        return true;
    ...
    @Override
    public int hashCode(){
        return 31*31*31*31*character+ textColor.hashCode()*31*31*31 + backgroundColor.hashCode()*31*31+ description.hashCode()*31;
    }
//        this.character = character;
//        this.textColor = textColor;
//        this.backgroundColor = backgroundColor;
