...
import byow.Core.ArgumentArgs;
import byow.Core.Draw_Menu;
...
public class TERenderer {
    private static final int TILE_SIZE = 16;// The TILE_SIZE originally is 16!
    private int width;
    private int height;
    private int xOffset;
    private int yOffset;
     ...
     */
    private TETile[][] draw_maze(TETile[][] world){
    ...
    public void renderFrame(TETile[][] world) {
        ...
        if(ArgumentArgs.Mode()) {
            while (!StdDraw.hasNextKeyTyped()) {
                ...
                draw_maze(world);
                Font bigFont = new Font("Monaco", Font.BOLD, 15);
                ...
                StdDraw.text(4, height - 2, world[x][y].description());
                StdDraw.enableDoubleBuffering();
                StdDraw.show();
            }
        }
